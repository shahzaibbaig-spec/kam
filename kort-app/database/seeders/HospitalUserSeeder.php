...
class HospitalUserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['name' => 'Dr. Ahmed Raza', 'email' => 'doctor@kort.local', 'employee_id' => 'KORT-0012', 'designation' => 'Consultant Doctor', 'department' => 'BICU', 'location' => 'LOC-BICU-01', 'role' => 'Doctor / Consultant'],
            ['name' => 'Sara Javed', 'email' => 'receptionist@kort.local', 'employee_id' => 'KORT-0013', 'designation' => 'Receptionist', 'department' => 'CBST', 'location' => 'LOC-CBST-02', 'role' => 'Receptionist'],
