...
<template>
    <Head :title="category ? 'Edit Inventory Category' : 'Create Inventory Category'" />

    <AuthenticatedLayout>
        <template #header>
            <PageHeader
                :title="category ? 'Edit Inventory Category' : 'Create Inventory Category'"
                description="Keep consumable categories clear enough for store officers, pharmacists, and clinical teams to find the right stock quickly."
            />
        </template>
